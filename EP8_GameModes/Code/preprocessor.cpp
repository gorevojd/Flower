...
b32 CheckNextToken(json_tokenizer* Tokenz, u32 TokenType)
{
...
b32 ParseSceneField(parse_scene_context* Context, parsed_scene* Scene)
{
    ...
    b32 Result = false;;
    if(CheckNextToken(Tokenz, JsonToken_Comma))
    {
        Result = true;
...
b32 ParseScene(parse_scene_context* Context)
{
    json_tokenizer* Tokenz = &Context->Tokenizer;
    ...
    while(ParseSceneField(Context, &Scene))
    {
