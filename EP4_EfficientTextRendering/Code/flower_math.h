...
inline m44 LookAt(v3 Pos, v3 TargetPos, v3 WorldUp) {
    ...
    // NOTE(Dima): I try to invert forward and left vectors because of perspective matrix
    Fwd = -Fwd;
...
/*Conversions*/
inline m44 M33ToM44(const m33& Matrix)
{
    m44 Result = {};
...
inline quat Euler2Quat(v3 EulerAngles){
    quat Result = {};
