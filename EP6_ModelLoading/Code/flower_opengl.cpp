...
INTERNAL_FUNCTION mesh_handles OpenGLAllocateMesh(mesh* Mesh, opengl_shader* Shader)
{
    ...
    glBufferData(GL_ARRAY_BUFFER, Mesh->VerticesDataBufferSize, 
                 Mesh->VerticesDataBuffer, GL_STREAM_DRAW);
    ...
    if(Mesh->IsSkinned)
    {
        ...
        if(OpenGLAttribIsValid(Shader->WeightsAttr))
        {
            ...
            glVertexAttribPointer(Shader->WeightsAttr,
                                  ...
                                  GL_FALSE,
                                  4 * sizeof(float), 
                                  (void*)(mi)Mesh->OffsetToBoneWeights);
        }
        ...
        if(OpenGLAttribIsValid(Shader->BoneIDsAttr))
        {
            ...
            glVertexAttribIPointer(Shader->BoneIDsAttr,
                                   ...
                                   GL_UNSIGNED_INT,
                                   sizeof(u32), 
                                   (void*)(mi)Mesh->OffsetToBoneIndices);
        }
    }
                                        ...
                                        v3 Color)
{
    ...
    glUniformMatrix4fv(Shader->ModelLoc, 1, GL_TRUE, ModelToWorld.e);
...
INTERNAL_FUNCTION void OpenGLRenderRectBuffer(render_params* RenderParams, 
...
INTERNAL_FUNCTION void OpenGLRender(render_params* RenderParams)
{
    ...
    OpenGLRenderRectBuffer(RenderParams, &Commands->Rects3D, true, true);
    OpenGLRenderRectBuffer(RenderParams, &Commands->Rects2D, false, false);
}