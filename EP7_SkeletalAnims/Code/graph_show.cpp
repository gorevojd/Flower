GAME_MODE_INIT(GraphShowInit)
{
    
}

GAME_MODE_UPDATE(GraphShowUpdate)
{
    ...
    f32 Factor = Clamp01((App->Time - TimeStart) / FadeDuration);
    f32 t = Smoothstep(Factor);
    f32 PongTime = PingPong(App->Time / 4.0f, 1.0f);
